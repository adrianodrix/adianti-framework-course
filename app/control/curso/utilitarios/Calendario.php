...
class Calendario extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->calendario->addEvent( 1, 'Evento 1', date('Y-m-d') . ' 12:00:00', '2019-11-10 14:00:00', null, '#C04747', $obj1);
        $this->calendario->addEvent( 2, 'Evento 2', date('Y-m-d') . ' 16:00:00', '2019-11-10 18:00:00', null, '#668Bc6', $obj2);
        $this->calendario->addEvent( 3, 'Evento 3', date('Y-m-d') . ' 12:00:00', '2019-11-12 14:00:00', null, '#FF0000', $obj3);
        $this->calendario->addEvent( 4, 'Evento 4', date('Y-m-d') . ' 16:00:00', '2019-11-12 18:00:00', null, '#5AB34B', $obj4);
